...
$GLOBALS['TL_LANG']['CTE']['vtxm_team_grid'] = ['Team Grid', 'Displays repeatable team profiles with image, biography, contact details and up to three additional links.'];
...
$GLOBALS['TL_LANG']['tl_content']['teamGridItems'] = ['Team profiles', 'Define repeatable people with person details, contact details and up to three additional links. Empty rows are ignored.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsImage'] = ['Person — image', 'Optional profile image. Missing or invalid images render no media element.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsAlt'] = ['Alternative text', 'Optional. Leave empty when the portrait is decorative and the adjacent name already conveys the same information. The name is not copied automatically.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsName'] = ['Name', 'Person name.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsRole'] = ['Role/function', 'Role, title or responsibility.'];
...
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsLink2Icon'] = ['Link 2: icon', 'Optional platform icon. Choose no icon for a text-only link.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsLink2Label'] = ['Link 2: label', 'Optional visible label. A label is required when External link is selected.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsLink2Url'] = ['Link 2: URL', 'A link is rendered only when the URL and at least an icon or label are present.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsLink3Icon'] = ['Link 3: icon', 'Optional platform icon. Choose no icon for a text-only link.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsLink3Label'] = ['Link 3: label', 'Optional visible label. A label is required when External link is selected.'];
$GLOBALS['TL_LANG']['tl_content']['teamGridItemsLink3Url'] = ['Link 3: URL', 'A link is rendered only when the URL and at least an icon or label are present.'];
...
$GLOBALS['TL_LANG']['tl_content']['teamGridLinkIconOptions'] = [
    'instagram' => 'Instagram',
    'linkedin' => 'LinkedIn',
    'github' => 'GitHub',
    'mastodon' => 'Mastodon',
    ...
    'x' => 'X',
    'website' => 'Website',
    'external-link' => 'External link (label required)',
];
